...
public class Main {
    ...
    private static void card3100win() {
        System.out.println("    You made it!  You're inside the Marsden house, the edifice that has haunted your nightmares " +
                ...
                "\n" +  // original text below
                " Congratulations!  You made it into the House of Danger!  Thank you for playing House of Danger REDUX.  " +
    ...
    private static void gameOver() { //original text below
        System.out.println(" It seems you've met with a terrible fate...\n" +
                "\n" +
                " Thank you for playing House of Danger REDUX.  I hope that it was an interesting experience for you.  " +
